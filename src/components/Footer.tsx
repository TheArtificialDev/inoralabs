...
export default function Footer() {
  return (
    <footer className="bg-quantum-blue text-white">
      {/* Newsletter section */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid md:grid-cols-5 gap-8 items-start">
          <div className="md:col-span-2">
            ...
            <Link href="/contact">
              <Button size="md" className="bg-white text-quantum-blue hover:bg-fog-gray transform hover:scale-105 transition-transform duration-300">
                Contact Us →
              </Button>
            </Link>
          </div>
        ...
        <div className="mt-6 pt-6 border-t border-white/10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm">
            ...
            <div>
              ...
              <ul className="space-y-1 font-ibm-plex">
                ...
                <li>
                  <Link href="/about" className="text-fog-gray/80 hover:text-white transition-colors">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/patents" className="text-fog-gray/80 hover:text-white transition-colors">
                    Patents & IP
                  </Link>
                </li>
                <li>
                  <Link href="/research" className="text-fog-gray/80 hover:text-white transition-colors">
                    Research
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-1 font-ibm-plex">
                ...
                <li>
                  <Link href="/careers" className="text-fog-gray/80 hover:text-white transition-colors">
                    Careers
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="text-fog-gray/80 hover:text-white transition-colors">
                    Contact
                  </Link>
                </li>
              </ul>
          ...
          <div className="mt-6 pt-4 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-fog-gray/60 hover:text-white transition-colors">
